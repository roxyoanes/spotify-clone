...
import PodcastsCard from "../../src/YourLibrary/PodcastsCard";
...
const Podcasts: NextPage<IProps> = ({ profileData }) => {
...
Podcasts.getInitialProps = async ({ reduxStore }: IReduxStoreProps) => {
...
export default withRedux(Podcasts);
